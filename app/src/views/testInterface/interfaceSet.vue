        ...
        <el-row style="margin-top: 20px">
            <el-table :data="tableInterfaceData" style="width: 100%"  >
                ...
                <el-table-column  fixed="right" align="center" label="操作" width="200">
                    <template  slot-scope="{row,$index}">
                        <i v-per="'interface_edit'"  class="el-icon-edit i_pry"    @click="change(row,$index,true)" ></i>
                        <i v-per="'interface_save'"  class="el-icon-check i_pry"     @click="save(row,$index)" ></i>
                        <i v-per="'interface_del'"   class="el-icon-delete i_pry"     @click="remove(row)" ></i>
                    </template>
                </el-table-column>
            </el-table>
